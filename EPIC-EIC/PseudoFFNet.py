...
class PseudoFFNet(nn.Module):
    ...
    def __call__(self, x):
        ...
        rng = self.make_rng("activation")

        rng, key, next_key = jax.random.split(rng, 3)
        ...
        y = fc1.apply(fc1_params, x, rngs = {"activation": key})
        ...
        y = ac1.apply(ac1_params, y, rngs = {"activation": key})
        ...
        y = fc2.apply(fc2_params, y, rngs = {"activation": key})
        ...
        y = ac2.apply(ac2_params, y, rngs = {"activation": key})
        ...
        y = fc3.apply(fc3_params, y, rngs = {"activation": key})
        ...
        y = ac3.apply(ac3_params, y, rngs = {"activation": key})
