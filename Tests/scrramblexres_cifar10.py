...
Best accuracy so far: 78.92%, Res: 64x2, 128x2, 256x6, Capsules: [50, 10], Connection probabilities: [0.2, 0.2], Batch size 64, relu, lr 3e-4
"""
import jax
import math
...
dataset_dict = {
    ...
    'train_steps': 20000, # run for longer, 30000 is good for CIFAR-10
...
model_parameters = {
    ...
    'connection_probabilities': [0.2, 0.3],
