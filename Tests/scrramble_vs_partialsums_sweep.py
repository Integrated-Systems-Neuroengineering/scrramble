...
# Load the models
# -------------------------------------------------------
scrramble50_state = pickle.load(open("/local_disk/vikrant/scrramble/models/sscamble_mnist_capsnet_recon_capsules50_acc_99_2025-08-07.pkl", "rb"))
ps50_state = pickle.load(open("/local_disk/vikrant/scrramble/models/partial_sums_full_precision_model_cores_50_acc_99_2025-08-07.pkl", "rb"))
